...
class ExploreSectionPostScreen extends StatefulWidget {
  ...
  const ExploreSectionPostScreen(
      {required this.sectionKey, required this.tabType, Key? key})
      : super(key: key);

  @override
  State<ExploreSectionPostScreen> createState() =>
      _ExploreSectionPostScreenState();
}
...
class _ExploreSectionPostScreenState extends State<ExploreSectionPostScreen> {
  ...
  void initState() {
    ...
    _explorePostCubit.getExploreSectionPostList(
        sectionKey: widget.sectionKey, tabType: widget.tabType);
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent ==
              scrollController.offset &&
          _loadMoreCubit.state is! LoadMoreLoading) {
        _loadMoreCubit.loadMoreExploreSectionPost(postPage,
            sectionKey: widget.sectionKey, tabType: widget.tabType);
      }
    });
    super.initState();

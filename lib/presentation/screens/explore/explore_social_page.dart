  ...
  reSetScrollController() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent ==
        ...
        _loadMoreCubit.getExploreTabPostList(socialPostPage,
                      ...
                      CustomPostsGrid(
                        ...
                        postListViewLoadMoreBody: PostListViewLoadMoreBody(
                          loadMoreFunctionName:
                              LoadMoreCubit.loadMoreExploreSectionFunction,
                        ...
                        builder: (context, state) {
                          ...
                          if (state is ExploreSocialPostListFailure) {
                            return ErrorHandler(exception: state.exception)
                                .buildErrorWidget(
                              context: context,
                              retryCallback: () => _exploreSocialPostCubit
                                  .getExploreSocialPostList(),
                            );
                          }
                          if (state is ExploreSocialPostListLoaded) {
                            return Column(
                              children: [
                                ...
                                BlocConsumer<LoadMoreCubit, LoadMoreState>(
                                    ...
                                    listener: (context, state) {
                                      ...
                                      if (state
                                          is LoadMoreSocialPostExploreLoaded) {

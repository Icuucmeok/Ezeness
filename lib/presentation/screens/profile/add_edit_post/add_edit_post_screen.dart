...
class _AddEditPostScreenState extends State<AddEditPostScreen> {
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                // if (widget.post == null) _buildPostDetailsPage(context),
                // // Default UI for new post
                // if (widget.post != null)
                BlocConsumer<PostCubit, PostState>(
                  ...
                  listener: (context, state) {
                    if (state is PostLoaded) {
                      ...
                      isVipController.text =
                          tempPost.isVip == 1 ? "true" : "false";
  ...
  Widget _buildMediaPage(BuildContext context) {
    ...
    return MediaLibrary(
      ...
      maxAssets: 10,
      // editedImagesLength: isEdit
      //     ? tempPost.postMediaList!.length
      //     : widget.sharedFiles?.length ?? mediaList!.length,
              ...
              GestureDetector(
                onTap: () {
                  AppModalBottomSheet.showMainModalBottomSheet(
                      context: context,
                      scrollableContent: _buildMediaPage(context));
                },
                child: Container(
                  width: 30,
                  height: 30,
            ...
            child: Row(children: [
              if (isEdit)
                ...tempPost.postMediaList!
                    .map((e) =>
                        EditPostMediaWidget()) //add this if resolve issue postMedia: e in constructor
                    .toList(),
              ...mediaList!

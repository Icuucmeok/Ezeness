...
class AppRouter {
  ...
  Route _buildAddEditPostScreenRoute(args) => SlideRouteTransition(
        MultiBlocProvider(
            providers: [
  ...
  Route _buildCalculateCoinScreen(args) =>
      SlideRouteTransition(MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (_) => CalculateCoinCubit(GoldCoinRepository(apiClient)),
          ),
          BlocProvider(
            create: (_) => ConvertCoinCubit(GoldCoinRepository(apiClient)),
          ),
          BlocProvider(
            create: (_) => ProfileCubit(ProfileRepository(apiClient)),
          ),
  ...
  Route _buildPrivacySecurityScreenRoute(args) => SlideRouteTransition(
      PrivacySecurityScreen());

  Route _buildCreateChangePasswordScreenRoute(args) => SlideRouteTransition(
      MultiBlocProvider(providers: [
        BlocProvider<ProfileCubit>(
          create: (_) =>
              ProfileCubit(ProfileRepository(apiClient)),
        ),
      ],

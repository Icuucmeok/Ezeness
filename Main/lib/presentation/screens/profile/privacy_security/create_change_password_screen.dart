...
class CreateChangePasswordScreen extends StatefulWidget {
  ...
  const CreateChangePasswordScreen({super.key});

  @override
  State<CreateChangePasswordScreen> createState() => _CreateChangePasswordScreenState();
}

class _CreateChangePasswordScreenState extends State<CreateChangePasswordScreen> {
      ...
      body:  BlocConsumer<SessionControllerCubit, SessionControllerState>(
          ...
          listener: (context, state) {
            if (state is SessionControllerCreateChangePasswordDone) {
              context.read<ProfileCubit>().getMyProfile(context.read<AppConfigCubit>());
              AppSnackBar(context: context,message: S.current.editSuccessfully).showSuccessSnackBar();
                  ...
                  CustomElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      _sessionControllerCubit.createChangePassword(
                         ...
                         oldPassword: user.isSetPassword?oldPasswordController.text:null,
                      );
                    },

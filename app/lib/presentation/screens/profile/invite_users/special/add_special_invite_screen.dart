...
class AddSpecialInviteScreen extends StatefulWidget {
  const AddSpecialInviteScreen({Key? key, required this.inviteUserCubit})
      : super(key: key);
  static const String routName = 'add_special_invite';

  final InviteUserCubit inviteUserCubit;

  @override
  State<AddSpecialInviteScreen> createState() => _AddSpecialInviteScreenState();
}

class _AddSpecialInviteScreenState extends State<AddSpecialInviteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(S.current.addSpecialInvite),
        elevation: 0,
      ),
      body: ListView(
              ...
              listener: (context, state) {
                ...
                if (state is InviteUserDone) {
                  AppSnackBar(
                      ...
                      .showSuccessSnackBar();
                  widget.inviteUserCubit.getInvitation(1);

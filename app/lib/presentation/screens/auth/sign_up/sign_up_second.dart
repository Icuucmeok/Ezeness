...
class SignUpSecond extends StatefulWidget {
  static const String routName = 'sign_up_second';
    ...
    return Scaffold(
      body: BlocConsumer<SessionControllerCubit, SessionControllerState>(
          listener: (context, state) {
            if (state is SessionControllerVerificationReSent) {
              ...
              child: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Text(
                      S.current.enterConfirmationCode,
                    ...
                    Wrap(
                      children: [
                        ...
                        Text(
                          _sessionControllerCubit.getVerificationValue(),
                          style:
                              Theme.of(context).textTheme.bodyLarge?.copyWith(
                    ...
                    CustomElevatedButton(
                      ...
                      onPressed: _start != 0
                          ? null
                          : () {
                              _sessionControllerCubit.reSendVerificationCode();
                            },
                      child: Text(
